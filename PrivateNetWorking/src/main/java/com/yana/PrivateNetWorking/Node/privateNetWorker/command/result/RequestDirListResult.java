...
class RequestDirListResult implements ICommandResult {

	@SuppressWarnings("unchecked")
	@Override
	public boolean settigResopnseData(byte[] reseponsePacketData) {
		FutureCommandResult<?> tmp = CommunicationStore.getFutureCommandResult(CommunicationCommand.REQUSET_DIRLIST);
		if(tmp == null) {
			return false;
		}
